class CfgWeapons
{
    ...
    class GerRng_PlateCarrier_Base: V_PlateCarrier1_rgr
    {
        ...
        hiddenSelectionsTextures[] = {"y\GR-Equipment-Mod\addons\equipment\vests\data\Tropentarn.paa"};
    ...
    class GerRng_PlateCarrier1_Flecktarn: GerRng_PlateCarrier_Base
    {
        ...
        model = "\A3\Characters_F\BLUFOR\equip_b_vest02";
        hiddenSelectionsTextures[] = {"y\GR-Equipment-Mod\addons\equipment\vests\data\Flecktarn.paa"};
        hiddenSelections[] = {"Camo"};
        author = "JAN";
    };
    ...
    class GerRng_PlateCarrier1_Flecktarn_B: GerRng_PlateCarrier_Base
    {
        ...
        model = "\A3\Characters_F\BLUFOR\equip_b_vest02";
        hiddenSelectionsTextures[] = {"y\GR-Equipment-Mod\addons\equipment\vests\data\Flecktarn_B.paa"};
        hiddenSelections[] = {"Camo"};
        author = "JAN";
    };
    ...
    class GerRng_PlateCarrier1_Wintertarn: GerRng_PlateCarrier_Base
    {
        ...
        model = "\A3\Characters_F\BLUFOR\equip_b_vest02";
        hiddenSelectionsTextures[] = {"y\GR-Equipment-Mod\addons\equipment\vests\data\Wintertarn.paa"};
        hiddenSelections[] = {"Camo"};
        author = "CFP";
    };
};