...
params [
    ...
    ["_effectiveClearingDistance", DEFAULT_MICLIC_DISTANCE, [0]],
    ["_fuseDelay", DEFAULT_MICLIC_DELAY, [0]],
    ["_chargeFuseDelay", DEFAULT_MICLIC_FUSE, [0]],
    ["_launchAngle", DEFAULT_MICLIC_ANGLE, [0]]
];
