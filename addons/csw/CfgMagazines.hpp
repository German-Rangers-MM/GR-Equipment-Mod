class CfgMagazines {
    ...
    class GVAR(150Rnd_127x99_mag): 100Rnd_127x99_mag{
        count = 150;
    };
    class GVAR(200Rnd_127x99_mag): 100Rnd_127x99_mag{
        count = 200;
    };
    ...
    class GVAR(150Rnd_127x99_mag_red): 100Rnd_127x99_mag_tracer_red{
        count = 150;
    };
    class GVAR(200Rnd_127x99_mag_red): 100Rnd_127x99_mag_tracer_red{
        count = 200;
    };
    ...
    // M2 SLAP
    class GVAR(100Rnd_127x99_mag_slap): 100Rnd_127x99_mag{
        count = 100;
        ammo = "B_127x99_SLAP";
    };
    class GVAR(150Rnd_127x99_mag_slap): GVAR(100Rnd_127x99_mag_slap){
        count = 150;
    };
    class GVAR(200Rnd_127x99_mag_slap): GVAR(100Rnd_127x99_mag_slap){
        count = 200;
    };
    ...
    class MAGAZINE(200Rnd_127x99_mag_slap_csw): MAGAZINE(100Rnd_127x99_mag_slap_csw){
        ...
        // M2 SLAP Tracer
    class GVAR(100Rnd_127x99_mag_slap_tracer_red): 100Rnd_127x99_mag_tracer_red{
        count = 100;
        ammo = "B_127x99_SLAP_Tracer_Red";
    };
    class GVAR(150Rnd_127x99_mag_slap_tracer_red): GVAR(100Rnd_127x99_mag_slap_tracer_red){
        count = 150;
    };
    class GVAR(200Rnd_127x99_mag_slap_tracer_red): GVAR(100Rnd_127x99_mag_slap_tracer_red){
        count = 200;
    };
