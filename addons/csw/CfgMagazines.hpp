class CfgMagazines {
    ...
    class 100Rnd_127x99_mag_red;
    class ger_100Rnd_127x99_mag_red: 100Rnd_127x99_mag_red{
        count = 100;
    };
    class ger_150Rnd_127x99_mag_red: 100Rnd_127x99_mag_red{
        count = 150;
    };
    class ger_200Rnd_127x99_mag_red: 100Rnd_127x99_mag_red{
        count = 200;
    };
