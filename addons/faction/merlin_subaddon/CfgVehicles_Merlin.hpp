...
class GVAR(CH149_Merlin_TTH): CUP_B_Merlin_HC3_GB
{
    author = "dalleburn, cookie";
    scope = 2;
    scopeCurator = 2;
    displayName = "CH-149 Merlin TTH";
    side = 1;
    faction = QGVAR(rangers_faction);
    crew = "CUP_B_GER_HPilot";
	...
	hiddenSelectionsTextures[]=
	{
		QPATHTOF(merlin_subaddon\data\CH-149_BW-HFlg_0_main.paa),
		QPATHTOF(merlin_subaddon\data\CH-149_BW-HFlg_1_tail.paa),
	};
...
class GVAR(CH149_Merlin_TTH_Armed): CUP_B_Merlin_HC3_Armed_GB
{
    author = "dalleburn, cookie";
    scope = 2;
    scopeCurator = 2;
    displayName = "CH-149 Merlin TTH (Armed)";
    side = 1;
    faction = QGVAR(rangers_faction);
    crew = "CUP_B_GER_HPilot";
...
class GVAR(CH149_Merlin_TTH_VIV): CUP_B_Merlin_HC3_VIV_GB
{
    author = "dalleburn, cookie";
    scope = 2;
    scopeCurator = 2;
    displayName = "CH-149 Merlin TTH (VIV)";
    side = 1;
    faction = QGVAR(rangers_faction);
    crew = "CUP_B_GER_HPilot";
