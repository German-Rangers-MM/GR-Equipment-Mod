...
class GVAR(Lkw5t_Covered_Armed_Wdl): CUP_B_T810_Armed_CZ_WDL
{
    ...
    displayName = CSTRING(lkw_5t_gtf_w);
...
{
    displayName = CSTRING(lkw_5t_gtf_d);
    hiddenSelections[] = {"camo1","camo2","camo3"};
    hiddenSelectionsTextures[] = {
...
class GVAR(Lkw5t_Covered_Reammo_Wdl): CUP_B_T810_Reammo_CZ_WDL
{
    side = 1;
    faction = QGVAR(rangers_faction);
    displayName = CSTRING(lkw_5t_utf_ammo_w);
    crew = "CUP_B_GER_BW_Fleck_Soldier";
    editorSubcategory = QGVAR(Lkw_Subcat);
    hiddenSelections[] = {"camo1","camo2","camo3"};
    hiddenSelectionsTextures[] = {
...
class GVAR(Lkw5t_Covered_Reammo_D): GVAR(Lkw5t_Covered_Reammo_Wdl)
{
    displayName = CSTRING(lkw_5t_utf_ammo_d);
    hiddenSelections[] = {"camo1","camo2","camo3"};
    hiddenSelectionsTextures[] = {
        QPATHTOF(tatra_subaddon\data\MG\Tropentarn\cabin2_bw_des_CO.paa),
        QPATHTOF(tatra_subaddon\data\MG\Tropentarn\bed_bw_desert_co.paa),
...
class GVAR(Lkw5t_Covered_Unarmed_Wdl): CUP_B_T810_Unarmed_CZ_WDL
{
    side = 1;
    faction = QGVAR(rangers_faction);
    displayName = CSTRING(lkw_5t_utf_w);
    crew = "CUP_B_GER_BW_Fleck_Soldier";
    editorSubcategory = QGVAR(Lkw_Subcat);
    hiddenSelections[] = {"camo1","camo2","camo3"};
    hiddenSelectionsTextures[] = {
...
class GVAR(Lkw5t_Covered_Unarmed_D): GVAR(Lkw5t_Covered_Unarmed_Wdl)
{
    displayName = CSTRING(lkw_5t_utf_d);
    hiddenSelections[] = {"camo1","camo2","camo3"};
    hiddenSelectionsTextures[] = {
        QPATHTOF(tatra_subaddon\data\MG\Tropentarn\cabin2_bw_des_CO.paa),
        QPATHTOF(tatra_subaddon\data\MG\Tropentarn\bed_bw_desert_co.paa),
...
class GVAR(Lkw5t_Covered_Repair_Wdl): CUP_B_T810_Repair_CZ_WDL
{
    side = 1;
    faction = QGVAR(rangers_faction);
    displayName = CSTRING(lkw_5t_utf_repair_w);
    crew = "CUP_B_GER_BW_Fleck_Soldier";
    editorSubcategory = QGVAR(Lkw_Subcat);
    hiddenSelections[] = {"camo1","camo2","camo3"};
    hiddenSelectionsTextures[] = {
...
class GVAR(Lkw5t_Covered_Repair_D): GVAR(Lkw5t_Covered_Repair_Wdl)
{
    displayName = CSTRING(lkw_5t_utf_repair_d);
    hiddenSelections[] = {"camo1","camo2","camo3"};
    hiddenSelectionsTextures[] = {
        QPATHTOF(tatra_subaddon\data\MG\Tropentarn\cabin2_bw_des_CO.paa),
        QPATHTOF(tatra_subaddon\data\MG\Tropentarn\bed_bw_desert_co.paa),
