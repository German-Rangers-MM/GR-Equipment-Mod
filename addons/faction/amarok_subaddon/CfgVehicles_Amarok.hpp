...
class GVAR(Amarok_covered_san_GER_Grn) : GVAR(Amarok_covered_GER_Grn)
{
	...
	class TransportItems
	{
		...
		class _xx_ACE_elasticBandage {name="ACE_elasticBandage";count=40;};
		class _xx_ACE_packingBandage {name="ACE_packingBandage";count=40;};
		class _xx_ACE_quikclot {name="ACE_quikclot";count=20;};
		class _xx_kat_chestSeal {name="kat_chestSeal";count=20;};
		class _xx_ACE_EarPlugs {name="ACE_EarPlugs";count=10;};
		class _xx_ACE_EntrenchingTool {name="ACE_EntrenchingTool";count=1;};
		class _xx_ACE_IR_Strobe_Item {name="ACE_IR_Strobe_Item";count=10;};
		class _xx_ACE_morphine {name="ACE_morphine";count=15;};
		class _xx_ACE_salineIV_500 {name="ACE_salineIV_500";count=40;};
		class _xx_ACE_splint {name="ACE_splint";count=25;};
		class _xx_ACE_wirecutter {name="ACE_wirecutter";count=1;};
		class _xx_kat_IV_16 {name="kat_IV_16";count=30;};
		...
		class _xx_ACE_epinephrine {name="ACE_epinephrine";count=15;};
		class _xx_kat_IO_FAST {name="kat_IO_FAST";count=30;};
		class _xx_kat_fentanyl {name="kat_fentanyl";count=25;};
		class _xx_kat_ketamine {name="kat_ketamine";count=25;};
		class _xx_kat_larynx {name="kat_larynx";count=25;};
		...
		class _xx_kat_oxygenTank_300_Item {name="kat_oxygenTank_300_Item";count=3;};
