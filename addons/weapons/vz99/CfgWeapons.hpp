...
class CfgWeapons {
    ...
    class GVAR(carryWeapon): Launcher_Base_F {
        ...
        model = "y\GR-Equipment-Mod\addons\GerRng_vz99\data\vz99_carry";
        picture = "\y\GR-Equipment-Mod\addons\GerRng_vz99\ui\weaponSide_ca.paa";
        modes[] = {};
